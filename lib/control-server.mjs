 ...
 */
export function startControlServer({ port, dataDir, uiHtmlPath, getState, setForcedGreeting, setEnabledWeekdays, setCommentSettings, setLiveWindow, testMessage, log }) {
